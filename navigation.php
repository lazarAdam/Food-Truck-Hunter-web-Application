...
<div class="container-fluid" id="cont1">
    ...
    <div class="row" id="row1">
        ...
        <a class="col-auto" data-toggle="modal" data-target="#myModal4" href="#myModal4" id="vendorSec" style="display: none">
            <img class="mx-auto img-fluid d-block" src="images/vendorLogo_small.png">vendor portal</a>
        <div class="col"></div>
    </div>
    <!-- The Modal -->
                ...
                <div class="modal-body">
                    <div class="row">
                        <a class="col" href="/register.php?vendor=true">
                            <img src="../images/vendor++.png" class=" mx-auto  d-block"> Vendor Sign Up</a>
                        <a class="col" href="../register.php?user=true">
                            <img src="../images/newUser.png" class=" mx-auto  d-block">User Sign Up</a>
    ...
    <div class="modal" id="myModal4">
        <div class="modal-dialog" id="md4">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Vendor portal</h4>
                    <button type="button" class="close" data-dismiss="modal">x</button>
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                    <div class="row">
                        <a class="col" href="../vendor_add_FT.php?rft=true" id="rqFt"  style="display: block">
                            <img src="../images/newVendor+.png" class=" mx-auto  d-block">add Food Truck</a>
                    </div>
                </div>
                <!-- Modal footer -->
                <div class="modal-footer">
